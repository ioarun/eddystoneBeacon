...
import com.example.arun.phy_web.R;
...
public class Device extends Activity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        devices = (ArrayList<BluetoothDevice>) Configure.mDevices;
    ...
    public void onItemClick(AdapterView<?> adapterView, View view,
        ...
        Intent intent = new Intent(Device.this, SetURI.class);
        intent.putExtra(EXTRA_DEVICE_ADDRESS, addr);
        intent.putExtra(EXTRA_DEVICE_NAME, name);
        startActivity(intent);
        Configure.instance.finish();
        finish();
    }
}
